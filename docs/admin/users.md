        ...
        <tr>
            ...
            <td valign="top" style="border: 1px solid #e0e0e0; padding: 20px;">
                <div style="margin-bottom: 15px; font-size: 0.85em; color: #666;">
                    <a href="docs/viewer/" style=" text-decoration: none;">Admin</a> &gt; 
                    <a href="docs/viewer/updates.md" style="color: #ac9e9e; font-weight: bold; text-decoration: none;">User Role Management</a>
                </div>           
