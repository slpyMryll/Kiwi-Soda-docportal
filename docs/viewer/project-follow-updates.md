        ...
        <tr>
            ...
            <td valign="top" style="border: 1px solid #e0e0e0; padding: 20px;">
                <div style="margin-bottom: 15px; font-size: 0.85em; color: #666;">
                    ...
                    <a href="../viewer/project-follow-updates.md" style="color: #ac9e9e; font-weight: bold; text-decoration: none;">Follow Project Updates</a>
                </div>           
                ...
                <table border="1" width="100%" cellpadding="8" cellspacing="0" style="border-collapse: collapse; font-size: 0.9em; border: 1px solid #ddd;">
                    ...
                    <tr>
                        ...
                        <td>To subscribe to selected projects in order to receive updates and monitor progress.</td>
                    </tr>
                    <tr>
                        <th align="left">Preconditions</th>
                        <td>
                            1. User must be logged in.<br>
                            2. There must be an existing project in the system.</td>
                    </tr>
                    <tr>
                        <th align="left">Main Scenario</th>
                        <td>
                            1. User navigates to a project dashboard.<br>
                            2. User clicks the "Follow" button of a project.<br>
                            3. System records the project in the user's subscription list.<br>
                            4. System confirms that the project is successfully followed.<br>
                            5. User receives future updates related to the followed project.
                        </td>
                    </tr>
                    <tr>
                        <th align="left">Outcome</th>
                        <td>The selected project is added to the user's followed list, enabling personalized updates and monitoring.</td>
                    </tr>
                </table>
            </td>
        </tr>
