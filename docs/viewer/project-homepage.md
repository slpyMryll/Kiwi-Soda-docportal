            ...
            <td valign="top" style="border: 1px solid #e0e0e0; padding: 20px;">
                ...
                <table border="1" width="100%" cellpadding="8" cellspacing="0" style="border-collapse: collapse; font-size: 0.9em; border: 1px solid #ddd;">
                    <tr>
                        ...
                        <td>Guest, Student Viewer</td>
                    </tr>
                    <tr>
                        <th align="left">Goal</th>
                        <td>To get a quick status update on USSC projects and find specific project details.</td>
                    </tr>
                    <tr>
                        <th align="left">Preconditions</th>
                        <td>1. User must have the correct URL to the site.</td>
                    </tr>
                    <tr>
                        <th align="left">Main Scenario</th>
                        <td>
                            1. User logs into OnTrack<br>
                            2. The system identifies the Viewer Role and loads the specialized Homepage.<br>
                            3. Student views the Project Highlights to see high-level progress of a specific project.<br>
                        </td>
                    </tr>
                    <tr>
                        <th align="left">Outcome</th>
                        <td>The student is informed of USSC activities/initiatives without needing administrative access or complex filtering.</td>
                    </tr>
                </table>
            </td>
        </tr>
