        ...
        <tr>
            ...
            <td valign="top" style="border: 1px solid #e0e0e0; padding: 20px;">
                <div style="margin-bottom: 15px; font-size: 0.85em; color: #666;">
                    ...
                    <a href="../viewer/milestones.md" style="color: #ac9e9e; font-weight: bold; text-decoration: none;">Milestone Tracker</a>
                </div>           
                ...
                It allows users to view project milestones, completion status, and upcoming deliverables
                in an organized chronological format.</p>
                <p>This feature enables viewers to track project development stages and monitor overall progress.
                It displays milestone indicators, progress percentages, and status labels to help users
                understand project performance and completion timelines.</p>
                ...
                <table border="1" width="100%" cellpadding="8" cellspacing="0" style="border-collapse: collapse; font-size: 0.9em; border: 1px solid #ddd;">
                    ...
                    <tr>
                        ...
                        <td>To monitor project progress and track milestone completion through a visual timeline.</td>
                    </tr>
                    <tr>
                        <th align="left">Preconditions</th>
                        <td>1. User must be logged in.<br>2. There must be an existing project in the system.<br> 3. Project milestones must exist in the system.  </td>
                    </tr>
                    <tr>
                        <th align="left">Main Scenario</th>
                        <td>
                            1. User navigates to the Milestone Tracker from the dashboard.<br>
                            2. System retrieves milestone data for the selected project.<br>
                            3. System displays milestones in a timeline view with status indicators and progress levels.<br>
                            4. User reviews milestone details including completion status and deadlines.
                        </td>
                    </tr>
                    <tr>
                        <th align="left">Outcome</th>
                        <td>User gains a clear understanding of project progress, milestone status, and upcoming deliverables.</td>
                    </tr>
                </table>
            </td>
        </tr>
