    ...
    <table width="100%" cellpadding="10" cellspacing="0" style="font-family: Arial, sans-serif; border-collapse: collapse;">
        ...
        <tr>
            <td width="25%" valign="top" style="border: 1px solid #e0e0e0; border-right: none;">
                ...
                <li style=""> <a href="../auth/project-homepage.md">Homepage</a><li>                     
            ...
            <td valign="top" style="border: 1px solid #e0e0e0; padding: 20px;">
                <div style="margin-bottom: 15px; font-size: 0.85em; color: #666;">
                    <a href="docs/viewer/" style=" text-decoration: none;">Homepage</a> &gt; 
                ...
                <p>This serves as a command center personalized for viewers to easily monitor their followed project. The hub provides overview stats cards which displays high-level metrics of the details in the interface. It also includes dynamic filtering between All Projects and Recent Updates to target display of information based on the viewer's preference.</p>
                ...
                <table border="1" width="100%" cellpadding="8" cellspacing="0" style="border-collapse: collapse; font-size: 0.9em; border: 1px solid #ddd;">
                    ...
                    <tr>
                        ...
                        <td>To quickly assess the progress of followed projects and identify which require immediate attention due to new updates.</td>
                    </tr>
                    <tr>
                        <th align="left">Preconditions</th>
                        <td>1. User must be logged in.<br>2.User must have followed at least one project.</td>
                    </tr>
                    <tr>
                        <th align="left">Main Scenario</th>
                        <td>
                            1. User navigates to the "My Following" page from the sidebar menu.<br>
                            2. System identifies all projects linked to the user's "Follow" list.<br>
                            3. System displays project cards showing banner, progress bar, and latest update time.<br>
                            4. User clicks "View Updates" to see specific announcement details.
                        </td>
                    </tr>
                    <tr>
                        <th align="left">Outcome</th>
                        <td>The viewer stays updated on project movement via a streamlined, visual dashboard.</td>
                    </tr>
                </table>
            </td>
        </tr>
