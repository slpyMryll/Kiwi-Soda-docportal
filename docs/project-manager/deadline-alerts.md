        ...
        <tr>
            ...
            <td valign="top" style="border: 1px solid #e0e0e0; padding: 20px;">
                <div style="margin-bottom: 15px; font-size: 0.85em; color: #666;">
                    ...
                    <a href="../project-manager/deadline-alerts.md" style="color: #ac9e9e; font-weight: bold; text-decoration: none;">Alerts</a>
                </div>          
                ...
                <table border="1" width="100%" cellpadding="8" cellspacing="0" style="border-collapse: collapse; font-size: 0.9em; border: 1px solid #ddd;">
                    ...
                    <tr>
                        ...
                        <td>To receive timely system notifications for approaching or missed task deadlines.</td>
                    </tr>
                    <tr>
                        <th align="left">Preconditions</th>
                        <td>Tasks must have a set end date. PM must be assigned to the project.</td>
                    </tr>
                    <tr>
                        <th align="left">Main Scenario</th>
                        <td>
                            1. The system scans the database for tasks with deadlines in the next 24 hours.<br>
                            2. A notification is triggered for the PM role.<br>
                            3. The notification bell icon badges with a count.<br>
                            4. PM clicks the bell to see the task name, project title, and due date.
                        </td>
                    </tr>
                    <tr>
                        <th align="left">Outcome</th>
                        <td>Increased project accountability through proactive time-management alerts.</td>
                    </tr>
                </table>
            </td>
        </tr>
